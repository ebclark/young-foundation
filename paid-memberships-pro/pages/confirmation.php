...
?>
	<?php if ( ! empty( $current_user->membership_level ) ) { ?>
		<a href="<?php echo pmpro_url( 'account' ); ?>" class="button"><?php _e( 'My network', 'paid-memberships-pro' ); ?></a>
	<?php } else { ?>
		<p><?php _e( 'If your account is not activated within a few minutes, please contact the site owner.', 'paid-memberships-pro' ); ?></p>
	<?php } ?>
